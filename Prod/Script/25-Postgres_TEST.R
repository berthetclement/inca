...
# table modele
tab_multiples_model <- readRDS("lot_20220127140733_multiple.RDS")
...
table_simple <- readRDS("lot_20220127140733_simple.RDS")
...
RPostgreSQL::dbWriteTable(con, name=c("pubmed_tmp","pubmed_mult"), value=tableau_NCT_Mult_form, append=TRUE, row.names=FALSE)
